...
use backend\modules\admin\models\query\ModuleQuery;
...
<div class="module-form">
    ...
    <div class="row">		
	    ...
	    <?php echo $form->field($model, 'icon')->textInput(['maxlength' => true]) ?>
             ...
             <?php echo $form->field($model, 'menu_group_id')->dropDownList(yii\helpers\ArrayHelper::map(\mdm\admin\models\Menu::find()->where("parent is null")->all(), 'id', 'name')) ?>
    	</div>
    </div>
    <div class="row">
 	<div class="col-md-12">
